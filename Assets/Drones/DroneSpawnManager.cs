...
namespace Drones
{
    public class DroneSpawnManager : MonoBehaviour
    {
        ...
        {
            for (var i = 0; i < pyroDronePool.Length; i++)
            {
                var drone = pyroDronePool[i];
        ...
        {
            GameObject pool = new GameObject("DronePool");
            ...
            for (int i = 0; i < lightingDronePool.Length; i++)
            {
                ...
                lightingDrone.droneSpawnManager = this;
