Shader "Hidden/Locked/.poiyomi/Poiyomi Pro URP/9b54483f9b66f664ea3f603f1f314690"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			#endif
			#ifdef VIGNETTE_MASKED
			void PoiLightingDependantModules(inout PoiLight poiLight, inout PoiFragData poiFragData, in MochieBRDFData mochieBRDFData,
			...
			float4 frag(VertexOut i, bool facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(1,0.0595112,0,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(1,0.0595112,0,1).a;
				#else
